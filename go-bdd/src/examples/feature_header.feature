Feature: Account creation
  ...
  Scenario: Account can be created successfully
    ...
    When I make a POST request to "/createaccount" using "post/create_account.json"
  ...
  Scenario: Invalid password is rejected
    Given I am unauthenticated
    When I make a POST request to "/createaccount" using "post/create_account_bad_password.json"
  ...
  Scenario: Email address already in use is rejected
    Given I am unauthenticated
    When I make a POST request to "/createaccount" using "post/create_account_dupe_email.json"
  ...
  Scenario: Invalid email address is rejected
    Given I am unauthenticated
    When I make a POST request to "/createaccount" using "post/create_account_bad_email.json"
    Then the response code should be BAD_REQUEST
